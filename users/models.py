...
from django.db.models import EmailField, ImageField, BooleanField
...
class CustomUser(AbstractUser):
    ...
    image = ImageField(blank=is_host, null=True)
    national_id_card = ImageField(blank=is_host, null=True)
